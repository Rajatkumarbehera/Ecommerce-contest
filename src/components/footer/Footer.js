...
const Footer = () => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch("https://users-email-fc740-default-rtdb.asia-southeast1.firebasedatabase.app/emails.json",
            {
                method: 'POST',
    ...
    return (
        <div className="footer-container">
            <div className="top-footer">
                <Link to="/">
                    <h3 className="footer-heading">AccioJob</h3>
                </Link>
            ...
            <div className="middle-footer">
                ...
                <div className="footer-content">
                    ...
                    <div className="user-data">
                        <input type="email" placeholder="Your Email" className="user-email" onChange={handleUserEmail} value={userEmail} />
                        <button className="subscribe-button" onClick={handleSubmit} >Subscribe</button>
                    </div>
                    <span>Lorem impsum dolor amit</span>
                </div>
            </div>

            <div className="bottom-footer">
                <p>Made With 💙 at AccioJob</p>
            </div>
        </div>
    )
}
